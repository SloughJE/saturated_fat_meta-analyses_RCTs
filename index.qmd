...
- short duration, high dropout rate
...
- The CI for a study’s RR is based on the event counts and the **total number of people in each group**.
- If the full randomized group is used, a trial with high turnover (dropouts) can appear statistically precise. (Minnesota)

- A tight CI may overstate the precision of a trial for long-term saturated fat reduction.
  - also BTW, the CI itself does not directly reflect how long participants actually stayed on the assigned diet.

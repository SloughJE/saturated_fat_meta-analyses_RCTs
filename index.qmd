...
- varied outcomes, varied interventions, extreme interventions
- many confounders
...
**Saturated Fat RCTs on hard endpoints:**

:::
::: {.incremental}

- No individual trial is a clean, adequately powered, adequately long unbiased test of SFA reduction on **hard outcome**s.
...
- What about no effect on cardiovascular or all-cause mortality?
- Doesn't that support the conclusion that reducing SFA does not reduce occurrence of these hard outcomes?
- From these trials, and meta-analyses, 2 reasonable interpretations:
  - **yes**, but with but with many caveats / limitations / low certainty
  - **no**, there is too much noise to support this conclusion.

:::
::: {.incremental}

- Each side picks their preferred trials or meta-analyses and outcomes.
- Each side argues why theirs is better.
...
- The RCTs included in these meta-analyses have major problems in design, conduct, and applicability, and do not provide reliable evidence in either direction.
  ...
  - They cannot establish that reducing dietary saturated fat lowers the occurrence of these hard outcomes, **or that it does not**.
